...
length(ans$changeContributions) # 500 as expected
...
length(ans$changeContributions) # 500 chainsas expected
head(ans$changeContributions[[1]][[1]][[1]])
...
length(ans4$changeContributions) # 50 chains as expected
length(ans4$changeContributions[[1]][[1]]) # 2 periods as expected
beh_steps <- sapply(ans4$changeContributions[[1]][[1]][[2]], function(ministep) attr(ministep, "networkName")) %in%  "mybeh"
...
beh_steps <- Filter(function(ministep) getDepvarName(ministep)  == "mybeh", ans4$changeContributions[[1]][[1]][[1]]) # 1st period, 1st group, 1st chain, behavior steps
...
net_steps <- Filter(function(ministep) getDepvarName(ministep)  == "mynet3", ans4$changeContributions[[1]][[1]][[1]]) # 1st period, 1st group, 1st chain, network steps
