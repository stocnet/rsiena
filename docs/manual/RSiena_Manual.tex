...
\item[Check your version of \RS]
  ...
  The version is
  identified by a version number (e.g.\ 1.3.22).
...
\verb|R CMD check RSiena_1.3.22.tar.gz|\\
...
to others, type\\
\verb|R CMD INSTALL --build RSiena_1.3.22.tar.gz| \\
...
\item 2023-05-16 GitHub, package version 1.3.23.
...
\item  Bug corrections:
   ...
   \item Continuous behavior added to returned simulated data
   \end{itemize}
\end{itemize}
