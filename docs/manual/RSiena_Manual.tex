...
\]
      ...
      using non-centered covariate and behavior values use \textt{{totDist2\_nc}}.
...
{\em GWDSPFF exposure} (\verb|gwdspFBExposure|)  and
{\em WDSPFB exposure} (\verb|gwdspFFExposure|) :
\[
      a_{i14}(x, z) = \sum_{h \neq i} z_h \,
