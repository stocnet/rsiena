...
This version was renewed for \RS version 1.3.3.
\end{abstract}
...
\item[Check your version of \RS]
  ...
  The version is
  identified by a version number (e.g.\ 1.3.3).
...
\verb|R CMD check RSiena_1.3.3.tar.gz|\\
...
to others, type\\
\verb|R CMD INSTALL --build RSiena_1.3.3.tar.gz| \\
...
\item Improvements of functionality:
   ...
   \item Trial values of \texttt{theta} used during Phase 2 of \sfn{siena07} added
     ...
     \texttt{sienaFit} object \texttt{ans} as \texttt{ans\$thetas}.
