...
This version was renewed for \RS version 1.4.23.
\end{abstract}
...
\item[Check your version of \RS]
  ...
  The version is
  identified by a version number (e.g.\ 1.4.23).
...
Some further material is at \url{https://www.stats.ox.ac.uk/~snijders/siena/EffectSizes_s.pdf}.
...
\verb|R CMD check RSiena_1.4.23.tar.gz|\\
...
to others, type\\
\verb|R CMD INSTALL --build RSiena_1.4.23.tar.gz| \\
...
\begin{itemize}
\item 
\begin{itemize} Bug corrections
  \item Repaired (hopefully) memory leak in \texttt{getTargetActorStatistics} and\\
    \texttt{getTargetsChangeContributions} in \texttt{siena07setup.cpp}.
  \item Repaired (hopefully) memory leak in \texttt{move} in \texttt{MLSimulation.cpp}.
...
\begin{itemize}
  ...
  \texttt{diffXInPop},
    \texttt{sameXInPopIntn},  \texttt{sameXInActIntn}, \texttt{homXOutAct2}.
  ...
  \texttt{sameXInPop}, \texttt{diffXInPop}, \texttt{sameXVInPop}, \texttt{sameXVInPop2}
