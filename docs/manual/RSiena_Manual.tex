...
This version was renewed for \RS version 1.2.34.
\end{abstract}
...
\item[Check your version of \RS]
  ...
  be found at the `Donwloads' page.
  The version is
  identified by a version number (e.g.\ 1.2.34).
...
\verb|R CMD check RSiena_1.2.34.tar.gz|\\
...
to others, type\\
\verb|R CMD INSTALL --build RSiena_1.2.34.tar.gz| \\
...
\item 2021-04-28 GitHub, package version 1.2.34.
...
\item Bug corrections:
   ...
   \item Correct names reported for tested effects (avoid error occurring 
