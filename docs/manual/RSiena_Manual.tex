...
This version was renewed for \RS version 1.2.32.
\end{abstract}
...
after downloading
\url{https://github.com/snlab-nl/rsiena/releases/download/v1.2.32/RSiena_winOS.zip},
...
\texttt{install.packages("\url{~//Downloads//RSiena\_linuxOS.tar.gz}", repos = NULL)}\\
            ...
            the root name of the file is \texttt{RSienaTest\_1.2.32}, and filling in the correct path name.
            ...
            for Windows:\\
             \texttt{install.packages("pathname to RSienaTest\_1.2.32.zip", repos = NULL, type="binary")}\\
            for Mac:\\
             \texttt{install.packages("pathname to RSienaTest\_1.2.32.tgz", repos = NULL, type="binary")}
             \item In \R from source:\\
            \texttt{install.packages("RSienaTest\_1.2.32.tar.gz", repos = NULL, type="source")}
            \item In \text{command.com} or in batch mode (Windows) from binary:\\
            \texttt{R CMD INSTALL RSienaTest\_1.2.32.zip}
            \item In the terminal (Mac) from binary:\\
            \texttt{R CMD INSTALL RSienaTest\_1.2.32.tgz}
            \item In \text{command.com} or in batch mode (Windows) or in the terminal (Mac) from source:\\
            \texttt{R CMD INSTALL RSienaTest\_1.2.32.tar.gz}
...
\item[Check your version of \RS]
  ...
  The version is
  identified by a version number (e.g.\ 1.2.32).
...
\verb|R CMD check RSiena_1.2.32.tar.gz|\\
...
to others, type\\
\verb|R CMD INSTALL --build RSiena_1.2.32.tar.gz| \\
...
\item 2021-03-12  GitHub, package version 1.2.32.

Changes in RSiena:
\begin{itemize}
   \item Generalized Method of Moments implemented (Viviana Amati):
     see\\
     \url{https://github.com/snlab-nl/rsiena/blob/develop/docs/manual/Changes_RSiena_GMoM.pdf};
...
\item 2020-12-10  GitHub, package version 1.2.32.\\
