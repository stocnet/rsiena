...
This version was renewed for \RS version 1.3.11.
\end{abstract}
...
\item[Check your version of \RS]
  ...
  The version is
  identified by a version number (e.g.\ 1.3.12).
...
\label{S_sienaBayes}
  ...
  model specification.
  It is available in packages \rst\ and \MS (see the \SI website).
...
\verb|R CMD check RSiena_1.3.12.tar.gz|\\
...
to others, type\\
\verb|R CMD INSTALL --build RSiena_1.3.12.tar.gz| \\
