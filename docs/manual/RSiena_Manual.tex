...
This version was renewed for \RS version 1.3.24.
\end{abstract}
...
\item[Check your version of \RS]
  ...
  The version is
  identified by a version number (e.g.\ 1.3.24).
...
For the internal effect parameters of user-defined interaction effects,
consult the help page of \sfn{includeInteraction}.
...
\verb|R CMD check RSiena_1.3.24.tar.gz|\\
...
to others, type\\
\verb|R CMD INSTALL --build RSiena_1.3.24.tar.gz| \\
...
\item 2023-07-21 GitHub, package version 1.3.24

Changes in RSiena:
\begin{itemize}
\item Corrections:
   \begin{itemize}
   \item In `getEffects`, the effects object was given an attribute `version`
     (was not correct in version 1.3.23).\\
    (This led to always giving a warning if any interaction effects were
    specified.)
  \item Corrections of implementation of acceptance by `sienaGOF` of a list of
