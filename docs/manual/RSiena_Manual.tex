...
This version was renewed for \RS version 1.3.8.
\end{abstract}
...
\item[Check your version of \RS]
  ...
  The version is
  identified by a version number (e.g.\ 1.3.8).
...
\verb|R CMD check RSiena_1.3.8.tar.gz|\\
...
to others, type\\
\verb|R CMD INSTALL --build RSiena_1.3.8.tar.gz| \\
...
consult the NEWS.md file (in earlier versions
this was the CHANGELOG file) in the source code,
which contains a more complete listing.
...
\item 2022-03-02 GitHub, package version 1.3.8.
