...
This version was renewed for \RS version 1.4.6.
\end{abstract}
...
\item[Check your version of \RS]
  ...
  The version is
  identified by a version number (e.g.\ 1.4.6).
...
\verb|R CMD check RSiena_1.4.6.tar.gz|\\
...
to others, type\\
\verb|R CMD INSTALL --build RSiena_1.4.6.tar.gz| \\
...
It is also possible to get the NEWS about any package that you installed
(such  as \rs) by giving the command
\begin{verbatim}
