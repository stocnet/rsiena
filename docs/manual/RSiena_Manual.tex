...
This version was renewed for \RS version 1.4.1.
\end{abstract}
...
reference to this manual can be obtained in \R from
\begin{verbatim}
citation("RSiena")
\end{verbatim}
...
\item[Check your version of \RS]
  ...
  The version is
  identified by a version number (e.g.\ 1.4.1).
...
\verb|R CMD check RSiena_1.4.1.tar.gz|\\
...
to others, type\\
\verb|R CMD INSTALL --build RSiena_1.4.1.tar.gz| \\
