...
This version was renewed for \RS version 1.5.6.
\end{abstract}
...
\item[Check your version of \RS]
  ...
  The version is
  identified by a version number (e.g.\ 1.5.6).
...
Note that the values given by \sfn{sienaRI} refer to each of the periods,
...
\verb|R CMD check RSiena_1.5.6.tar.gz|\\
...
to others, type\\
\verb|R CMD INSTALL --build RSiena_1.5.6.tar.gz| \\
...
\item Improvements of functionality:
   \begin{itemize}
    ...
    \item \sfn{sienaRIDynamics} reinstated based on the above new option,
