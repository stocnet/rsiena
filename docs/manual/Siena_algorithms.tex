...
Redefining both is superfluous, as is shown by the above.
(If they would both be redefined for some effect, then
 \nnm{tieStatistic} for this effect would never be used.)
...
In C++, whether an effect is an ego effect is used in
